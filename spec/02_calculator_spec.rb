...
describe "#multiply" do
  ...
  it "multiplies two other numbers, one of them being 0" do 
    ...
    expect(multiply(0, 1337)).to eq(0)
  end
end
...
describe "#power" do
  ...
  it "is the identity function if the exponent is 1" do
    expect(power(15, 1)).to eq(15)
  end
end
...
describe "#factorial" do
  ...
  it "computes the factorial of 5" do
    expect(factorial(5)).to eq(2*3*4*5)
  end
  it "computes the factorial of 10" do
    expect(factorial(10)).to eq(2*3*4*5*6*7*8*9*10)
  end
end
